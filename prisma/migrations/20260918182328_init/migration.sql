...
-- CreateEnum
CREATE TYPE "Purity" AS ENUM ('S925', 'S999', 'PLATED', 'GOLD_PLATED', 'OXIDISED');

-- CreateEnum
CREATE TYPE "PriceMode" AS ENUM ('FIXED', 'WEIGHT');
...
-- CreateEnum
CREATE TYPE "CouponType" AS ENUM ('PERCENT', 'FLAT', 'FREESHIP');

-- CreateEnum
CREATE TYPE "CollectionKind" AS ENUM ('MANUAL', 'AUTO');
...
CREATE TABLE "Product" (
    ...
    "purity" "Purity" NOT NULL DEFAULT 'S925',
    "priceMode" "PriceMode" NOT NULL DEFAULT 'FIXED',
    "price" INTEGER NOT NULL,
    "compareAtPrice" INTEGER,
    "weightG" DECIMAL(10,3),
    "makingCharge" INTEGER,
    "makingChargePct" DECIMAL(5,2),
...
CREATE TABLE "OrderItem" (
    ...
    "weightG" DECIMAL(10,3),
    "purity" "Purity",
    "taxRate" DECIMAL(5,2) NOT NULL DEFAULT 3.0,
...
-- CreateIndex
CREATE INDEX "MetalRate_metal_purity_effectiveFrom_idx" ON "MetalRate"("metal", "purity", "effectiveFrom");
...
-- AddForeignKey
ALTER TABLE "MetalRate" ADD CONSTRAINT "MetalRate_setById_fkey" FOREIGN KEY ("setById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
